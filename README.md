...
Welcome to my cybersecurity portfolio. This repository is a curated collection of my work from the Cybersecurity diploma program at NSCC (Waterfront Campus). It showcases my practical skills and theoretical understanding across various domains, including penetration testing, network security, physical security, incident response, and secure system design.
...
- **Offensive Security:** Nmap, Metasploit, Hydra, John the Ripper, Wifite, Reaver, Nikto, DirBuster, Burp Suite, Wapiti.
- **Defensive Security:** UFW, iptables, Snort, system hardening, patch management, backup strategies, security audits.
- **Network Security:** VLANs, subnetting (CIDR), routing protocols (RIP), SSH, DNS configuration, network segmentation.
- **Risk Management:** Threat modeling (STRIDE), risk assessment (DREAD), incident response planning, physical security assessments.
- **Scripting & Development:** Bash scripting, Python, SQL database design, Git/GitHub.
- **Operating Systems:** Linux (Ubuntu, Debian, Kali), Windows, Cisco IOS (simulated).
- **Frameworks & Standards:** NIST, CIS Controls, FOIPOP, Treasury Board of Canada policies.
